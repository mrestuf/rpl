...
<body class="hold-transition skin-puRPLe sidebar-mini">
    <div class="wrapper">
        ...
        include "../lib/koneksi.php";
        //cek no_transaksi
        $query="SELECT no_transaksi FROM tbtransaksi ORDER BY no_transaksi DESC LIMIT 1";
    ...
    ?>
    <h3 style="margin-left:10px; margin-bottom:10px">No. invoice       : <?php echo $no_transaksi; ?></h3>
    <h4 style="margin-left:10px; margin-bottom:10px"> Tanggal Transaksi : <?php echo $tgl; ?> </h4>
    <h4 style="margin-left:10px; margin-bottom:10px">Kasir             : <?php echo $nama; ?></h4>
    ...
    <h4 style="margin-left:10px; margin-bottom:10px">Total : Rp. <?php echo $total; ?></h4>
    <a class="btn btn-default" href="transaksi.php" style="margin-left:10px; margin-bottom:10px">Kembali Transaksi</a>
    <a class="btn btn-primary"href="cetak.php" target="_blank" style="margin-left:10px; margin-bottom:10px">Print</a>
