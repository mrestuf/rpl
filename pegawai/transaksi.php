...
<body class="hold-transition sidebar-mini">
    ...
    if (mysqli_num_rows($cek)!=0){
        ...
        <h1 style="margin-left:10px"><?php echo $no_transaksi?></h1>

        <div class="row-ml-3" style="margin-left: 15px; margin-bottom: 10px">
    ...
    ?>
        ...
        <div class="form-group" style="margin-left:10px; padding-bottom:15px;">
