        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    ?>
                    <h1 style="margin-left:10px">Laporan Periode <?php echo $tglawal, " sampai ", $tglakhir; ?></h1>
                    ...
                    <div class="form-group"> 
                        <a style="margin-left:10px; margin-bottom:5px;"class="btn btn-default" href="laporan.php">Kembali</a>
                        <form class="btn" style="margin-bottom:5px;" action="cetak_laporan.php" method="POST">
                            <input type="hidden" name="tglawal" value=<?php echo $tglawal; ?>>
                            <input type="hidden" name="tglakhir" value=<?php echo $tglakhir; ?>>
                            <input class="btn btn-default" type="submit" name="submit1" value="Print">
                        </form>
                    </div>
