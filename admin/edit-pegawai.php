...
$query = "SELECT * FROM tbpegawai WHERE nip = '$nip' LIMIT 1";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="update-pegawai.php" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                            <label class="form-label" for="nip">nip</label>
                                <input type="text" name="nip" value="<?= $row['nip']?>"
                                    class="form-control form-control-lg" />
                                
                            </div>
                            <div class="form-group">
                            <label class="form-label" for="nama_pegawai">nama_pegawai</label>
                                <input type="text" name="nama_pegawai" value="<?=$row['nama_pegawai']?>"
                                    class="form-control form-control-lg" />
