                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/RPL/admin/view.php?id=<?= $notransaksi ?>" class="btn btn-default" style="margin-left:5px; margin-right:5px;">Detail </a>
                                    <a href="hapus_data.php?id=<?php echo $notransaksi; ?>" class="btn btn-danger" style="margin-left:5px; margin-right:5px;">Delete</a>
                                    <a href="print_data.php?id=<?php echo $notransaksi; ?>" class="btn btn-default" style="margin-left:5px; margin-right:5px;">Print</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
