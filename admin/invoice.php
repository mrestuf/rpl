...
<body class="hold-transition skin-puRPLe sidebar-mini">
    ...
    <h4 style="margin-left:15px; margin-bottom:15px;">Total : Rp. <?php echo $total; ?></h4>
    <a style="margin-left:10px; margin-bottom:10px;" class="btn btn-default" href="transaksi.php">Kembali</a>
    <a  style="margin-left:10px; margin-bottom:10px;"class="btn btn-primary"href="cetak.php" target="_blank">Print</a>
