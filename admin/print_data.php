            ...
            <section class="sidebar" style="background-color:lightgrey">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="menu-admin.php"><i class="fa fa-circle-o"></i> User </a></li>
                            <li><a href="meja-admin.php"><i class="fa fa-circle-o"></i> Pegawai </a></li>
                            <li><a href="meja-admin.php"><i class="fa fa-circle-o"></i> Barang </a></li>
                        </ul>
                    </li>
                </ul>
            </section>
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <h4 style="margin-left:10px; margin-bottom:15px; margin-top:15px;">Total : <?php echo $total; ?></h4>
                        <script>
                            window.print();
                        </script>
