...
$pegawaiQuery = "SELECT * FROM tbpegawai";

$pegawaiData = mysqli_query($koneksi, $pegawaiQuery);
?>
                ...
                <div class="box">
                            ...
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                <div class="input-group-btn">
                                    <button type="submit" class="btn btn-default"><a
                                            href="/RPL/admin/input-pegawai.php"><i
                                                class="fa fa-plus-square"><strong>Tambah Data
                                                    Pegawai</strong></i></a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php while($pegawai = mysqli_fetch_assoc($pegawaiData)){ ?>
                            <tr>
                                <td><?= $pegawai['nip'] ?></td>
                                <td><?= $pegawai['nama_pegawai'] ?></td>
                                <td><a class="btn btn-default btn-block btn-flat"
                                        href="/RPL/admin/edit-pegawai.php?nip=<?= $pegawai['nip'] ?>">
                                        <i class="fa fa-edit"> Edit</i>
                                    </a>
                                    <a class="btn btn-danger btn-block btn-flat"
                                        href="/RPL/admin/delete-pegawai.php?nip=<?= $pegawai['nip'] ?>">
