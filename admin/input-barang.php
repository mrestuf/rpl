        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="add-barang.php" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="nama_produk">nama_barang</label>
                            ...
                            <div class="form-group">
                                <label for="nama_produk">satuan_brg</label>
                                <input type="text" class="form-control" name="satuan_brg" id="satuan_brg"
                                    placeholder="Masukkan satuan_brg">
                            </div>
                            <div class="form-group">
                                <label for="nama_produk">harga_barang</label>
