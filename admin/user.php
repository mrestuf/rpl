...
$userData = mysqli_query($koneksi, $userQuery);
?>
                ...
                <div class="box">
                            ...
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                <div class="input-group-btn">
                                    <button type="submit" class="btn btn-default"><a
                                            href="/RPL/admin/input-user.php"><i
                                                class="fa fa-plus-square"><strong>Tambah Data
                                                    User</strong></i></a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php while($user = mysqli_fetch_assoc($userData)){ ?>
                            <tr>
                                <td><?= $user['username'] ?></td>
                                <td><?= $user['password'] ?></td>
                                <td><?= $user['hakakses'] ?></td>
                                <td><a class="btn btn-default btn-block btn-flat"
                                        href="/RPL/admin/edit-user.php?username=<?= $user['username'] ?>">
                                        <i class="fa fa-edit"> Edit</i>
                                    </a>
                                    <a class="btn btn-danger btn-block btn-flat"
                                        href="/RPL/admin/delete-user.php?username=<?= $user['username'] ?>">
