...
<body class="hold-transition skin-puRPLe sidebar-mini">
    ...
    <h4 style="margin-left:12px; margin-bottom:10px;">Kasir : <?php echo $nama; ?></h4>
    ...
    <h4 style="margin-left:10px; margin-bottom:10px;">Total : <?php echo "Rp. ",number_format($total,0,",","."); ?></h4>
    <a  style=" margin-bottom:10px;"class="btn btn-default btn-block"href="laporan.php">Kembali</a>
