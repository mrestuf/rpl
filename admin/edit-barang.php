...
$query = "SELECT * FROM tbbarang WHERE kode_barang = '$kode_barang' LIMIT 1";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="update-barang.php" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                            <label class="form-label" for="kode_barang">kode_barang</label>
                            ...
                            <div class="form-group">
                            <label class="form-label" for="satuan_brg">satuan_brg</label>
                                <input type="text" name="satuan_brg" value="<?=$row['satuan_brg']?>"
                                    class="form-control form-control-lg" />
                                
                            </div>
                            <div class="form-group">
                            <label class="form-label" for="harga_barang">harga_barang</label>
