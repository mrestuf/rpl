...
$barangQuery = "SELECT * FROM tbbarang";

$barangData = mysqli_query($koneksi, $barangQuery);
?>
                ...
                <div class="box">
                            ...
                            <div class="input-group input-group-sm hidden-xs" style="width: 150px;">
                                <div class="input-group-btn">
                                    <button type="submit" class="btn btn-default"><a
                                            href="/RPL/admin/input-barang.php"><i
                                                class="fa fa-plus-square"><strong>Tambah Data
                                                    Barang</strong></i></a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php while($barang = mysqli_fetch_assoc($barangData)){ ?>
                            <tr>
                                ...
                                <td><a class="btn btn-default btn-block btn-flat"
                                        href="/RPL/admin/edit-barang.php?kode_barang=<?= $barang['kode_barang'] ?>">
                                        <i class="fa fa-edit"> Edit</i>
                                    </a>
                                    <a class="btn btn-danger btn-block btn-flat"
                                        href="/RPL/admin/delete-barang.php?kode_barang=<?= $barang['kode_barang'] ?>">
